...
const Operatinghours = ({ restaurantNo }) => {
  ...
  const handleAddBreakTime = (day) => {
    operatingHoursInfo[day].startTime == "" &&
    operatingHoursInfo[day].endTime == ""
      ? setOperatingHoursInfo((prev) =>
          prev.map((info, index) =>
            index === day
              ? {
    ...
    operatingHoursInfo[day].breakStartTime != "" &&
    operatingHoursInfo[day].breakEndTime != ""
  ...
  const handleSubmit = () => {
    const updated = operatingHoursInfo.map((info, index) => ({
      ...info,
      restaurantNo: restaurantNo,
      weekDay: dayOfWeek[index],
    }));

    setOperatingHoursInfo(updated);
      ...
      {operatingHoursModal && (
        <ModalWrapper>
          ...
          <ModalLabel>
            ...
            <ModalContent>
              <TimeWrapper>
                {operatingHoursInfo.map((info, index) => (
                  <div key={index}>
                    <TimeRow>
